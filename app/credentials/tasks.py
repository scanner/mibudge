#!/usr/bin/env python
#
"""Celery tasks for the credentials app."""
...
from credentials.notification_kinds import API_KEY_EXPIRING
from notifications.service import notify

logger = logging.getLogger("credentials.tasks")
...
def notify_expiring_api_keys() -> None:
    ...
    'credentials.api_key_expiring' notification, giving them time to
    mint a replacement key.  Each key is warned about exactly once:
